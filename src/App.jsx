...
import {
  ...
  Building2, Check, ChevronDown, ChevronRight, CircleHelp, Clock3, FileCheck2,
  FileSearch, Files, GitBranch, LayoutDashboard, Link2, ListChecks, Menu, Plus,
  Search, Settings, ShieldAlert, Sparkles, Users, X, Zap
} from "lucide-react";
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      <header className="topbar">
        ...
        <div className="top-actions"><button className="icon-button"><Search size={19}/></button><button className="icon-button notification"><Bell size={19}/><i/></button><div className="decision-chip"><span>当前建议</span><b>有条件进入下一轮</b></div><button className="primary" onClick={()=>setReview(true)}><Zap size={16}/>启动投委会复审</button></div>
      </header>
      ...
      <div className="workspace">
        <section className="graph-panel">
          ...
          <div className="claim-map">
            <div className="root-card"><div className="root-icon"><Building2 size={24}/></div><div><span>目标公司</span><b>星穹智算科技</b><small>AI基础设施 · B轮融资</small></div><div className="root-score"><b>76</b><span>决策可信度</span></div></div>
        ...
        <aside className="insights">
          ...
          <div className="big-score"><div className="score-ring"><b>76</b><span>/100</span></div><div><b>可进入复审</b><span>较昨日 +4</span><small>2项重大风险待人工判断</small></div></div>
          ...
          <div className="risk-title"><b><AlertTriangle size={15}/>重大风险</b><span>2项</span></div>
